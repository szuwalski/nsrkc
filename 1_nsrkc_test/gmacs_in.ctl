...
2
# mean_wt_inv
 0.491407 0.87147 1.13611 1.79719 2.36195 3.03182 3.78502 4.43349
# maturity
 0 0 0 1 1 1 1 1
# legal
 0 0 0 0 1 1 1 1
...
# Growth parameters
# Initial_value Lower_bound Upper_bound Phase Prior_type Prior_1 Prior_2
 36.349 5 50 -3 0 0 20
 0.236 -0.5 0.5 -3 0 0 10
 0.75 0.2 3 -3 0 0 3
 100 65 165 2 0 0 170
 0.07 0 1 2 0 0 3
...
#  Winter_Com Summer_Com ADFG_Trawl NMFS_Trawl
 1 1 1 1 # selectivity periods
 0 0 0 0 # sex specific selectivity (1=Yes, 0=No)
 8 2 2 2 # selectivity type (by sex)
 0 0 0 0 # selectivity within another gear
 2 0 0 0 # extra parameters for each pattern
 1 1 1 1 # retention periods 
 0 0 0 0 # sex specific retention (1=Yes, 0=No)
 2 2 6 6 # retention type (by sex)
 1 1 0 0 # retention flag
 0 0 0 0 # extra parameters for each pattern
...
# Fleet Index Parameter_no Sex Initial Lower_bound Upper_bound Phase Prior_type Prior_1 Prior_2 Start_block End_block
 ...
 1 2 2 0 2 0.2 20 0 0.1 100 2 1976 2019
 1 3 3 0 0.5 0.1 1 0 0.1 100 2 1976 2019
 1 4 4 0 0.3 0.1 1 0 0.1 100 2 1976 2019
 ...
 4 8 2 0 3 0.1 20 0 0.1 100 3 1976 2019
...
# Initial Lower_bound Upper_bound Phase Prior_type Prior_1 Prior_2 Index_lambda Index_lambda
 0.896 0.1 2 4 0 0.1 1 0 1 1
 1 0.1 2 -2 0 0.1 1 0 1 1
 0.0015 0 2 3 0 0 1 0 1 1
 1 0.1 2 -4 0 0.1 1 0 1 1
# Index CV
...
#  Winter_Com Winter_Com Winter_Com Winter_Com Summer_Com Summer_Com Summer_Com Summer_Com Summer_Com Summer_Com ADFG_Trawl ADFG_Trawl NMFS_Trawl NMFS_Trawl
