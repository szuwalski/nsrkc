...
# ival        lb        ub        phz   prior     p1      p2         # parameter         #
# —————————————————————————————————————————————————————————————————————————————————————— #
  36.349       5.0      50.0          -3       0    0.0    20.0         # alpha males or combined
   0.236      -0.5       0.5         -3       0    0.0    10.0         # beta males or combined
...
## Gear-1    Gear-2   Gear-3   Gear-4
   ...
   0         0        0        0         # extra
   1 		 1 		  1 	   1 		 # determine if maximum selectivity at size is forced to equal 1 or not
##  ————————————————————————————————————————————————————————————————————————————————————##
...
# Gear-1
   ...
   1     2     2   0     2.0   0.2   20   0      0.1   100    2     1976   2019
   1     3     3   0     0.5   0.1   1.0   0      0.1   100    2     1976   2019
   1     4     4   0     0.3   0.1   1.0   0      0.1   100    2     1976   2019
# Gear-2
...
# Log_fdevs   meanF       Mdevs  Rec_devs Initial_devs Fst_dif_dev Mean_sex-Ratio Molt_prob Free selectivity	Init_n_at_len	
     10000       0        1.0         2            0           1             10     0      		0			 	0			          #(10000)
